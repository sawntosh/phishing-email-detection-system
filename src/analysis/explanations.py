...
_EXACT = {
    ...
    "open_redirect_param": "The link passes another URL as a parameter and would bounce the reader to a different site than the one shown.",
    ...
    "embedded_url_in_path": "Another full URL is embedded in the link path, a trick used to make a malicious link look like a trusted one.",
